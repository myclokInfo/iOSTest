...
set -o pipefail & xcodebuild test -workspace iOSTest.xcworkspace -scheme "iOSTest" -destination 'platform=iOS Simulator,OS=12.0,name=iPhone 8' -enableCodeCoverage YES -only-testing:iOSTestTests| tee xcodebuild.log | xcpretty
